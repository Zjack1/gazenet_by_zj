import model_mobilenetv2_headpose
import reader
import numpy as np
import torch
...
if __name__ == "__main__":
  ...
  net = model_mobilenetv2_headpose.model()
  net.train()
  net.to(device)
  net.load_state_dict(torch.load("./Iter_headpose_L1_18_GazeNet.pt"))
  ...
  for epoch in range(1, config["params"]["epoch"] + 1):
    ...
    if epoch % config["save"]["step"] == 0:
      torch.save(net.state_dict(), os.path.join(savepath, f"Iter_headpose_L1_{epoch}_{modelname}.pt"))
